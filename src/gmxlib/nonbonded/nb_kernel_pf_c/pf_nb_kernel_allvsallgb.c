                     ...
                     void *                 work)
{
	...
	for(i=ni0; i<ni1; i++)
	{
		...
		/* for pairwise forces, the vdw and coulomb parts are needed separately */
		pf_coul          = -(fijC-fscal)*rinv;
		...
		fscal            = pf_lj + pf_coul;
                ...
                /* save pairwise forces */
                if (pf_global->bInitialized)
		  pf_atom_add_nonbonded(fr->pf_global, i, k, pf_coul, pf_lj, dx, dy, dz);
            }
