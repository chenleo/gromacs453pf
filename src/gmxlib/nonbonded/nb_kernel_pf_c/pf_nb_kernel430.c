		    ...
		    t_pf_global *      pf_global)
{
    ...
    do
    {
        ...
        *count           = nn1;            
		...
		pf_coul          = -(fijC-fscal)*rinv11;
		pf_lj            = -(fijD+fijR)*tabscale*rinv11;
...
/*
 * Gromacs nonbonded kernel pf_nb_kernel430nf
 * Coulomb interaction:     Generalized-Born
 * VdW interaction:         Tabulated
 * water optimization:      No
 * Calculate forces:        no
 */
void pf_nb_kernel430nf(
                    int *           p_nri,
                    int *           iinr,
                    int *           jindex,
                    int *           jjnr,
